...
export default async function HomePage() {
	...
	return (
		<section className='mx-auto w-full max-w-6xl px-4 py-10 pb-12 sm:px-6 sm:py-12'>
			...
			<div className='mt-6 grid gap-6 sm:mt-8 sm:gap-8 md:grid-cols-2 xl:grid-cols-3'>
