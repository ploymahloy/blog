...
export interface AdminPostDraftState {
	post: BlogPost;
}
...
export function isAdminPostDraftState(value: unknown): value is AdminPostDraftState {
	if (!value || typeof value !== 'object') return false;
	const candidate = value as AdminPostDraftState;
	return typeof candidate.post === 'object' && candidate.post !== null && typeof candidate.post.id === 'string';
}
